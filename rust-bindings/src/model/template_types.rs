    ...
    fn new(
        ...
        PyEnvironmentActions {
            inner: EnvironmentActions {
                ...
                // RFC 0008 WRAP_ACTIONS hooks are handled by the pure-Python v0
                // session runtime, not this _v1 binding, so they are not
                // surfaced here yet. Initialize to None to match the openjd-rs
                // EnvironmentActions layout.
